...
public class A_EntityManagerLifeCycleTests {
    ...
    * */
    ...
    private static EntityManagerFactory entityManagerFactory2;//팩토리는 싱글톤으로 관리
    ...
    public static void initFactory(){
        ...
        entityManagerFactory2 = Persistence.createEntityManagerFactory("jpatest");
    }
    ...
    public void 엔티티_매니저_팩토리와_엔티티_매니저_생명주기_확인1(){
        ...
        System.out.println("entityManagerFactory.hashCode = " + entityManagerFactory2.hashCode());
        System.out.println("entityManager.hashCode() = " + entityManager2.hashCode());
    }
