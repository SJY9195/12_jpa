...
public class PagingTests {
    ...
    * JPA 는 이러한 페이징을 API(여기서는 미리 만들어놓은 메소드들) 를 통해 추상화해서 간단하게 처리할 수 있도록 제공한다.
    *
    ...
    *   : 데이터의 일부만을 한 번에 조회하여 성능을 개선하고,
     ...
     * 페이징을 통해 필요한 데이터만을 갖고오는 것이 유리하다.
    * */
    ...
    void 페이징_api를_이용한_조회_테스트(){
        ...
        List<Menu> menuList = entityManager.createQuery(jpql, Menu.class)
                .setFirstResult(offset) // 시작위치  //API
                .setMaxResults(limit) // 조회할 갯수 //API
                .getResultList();
